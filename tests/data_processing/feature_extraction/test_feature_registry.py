...
from src.data_processing.feature_extraction.feature_registry import FeatureRegistryMeta, get_feature_registry_info
...
class TestFeatureRegistry:
    ...
    def test_auto_import_features(self):
        ...
        from src.data_processing.feature_extraction.feature_registry import FeatureRegistryMeta
        original_size = FeatureRegistryMeta.get_registry_size()
        
        # Import the features module to trigger auto-registration
        try:
            from src.data_processing.feature_extraction import features
        except ImportError:
